            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li> <a class="waves-effect waves-dark" href="<?php echo site_url('publishing/dashboard'); ?>" aria-expanded="false"><i class="fa fa-user-o text-success"></i><span class="hide-menu">Dashboard</span></a></li>
                        <li> <a class="has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><i class="icon-speedometer"></i><span class="hide-menu">Publishing </a>
                            <ul aria-expanded="false" class="collapse">
                                <li><a href="<?php echo site_url('publishing/dashboard'); ?>">Blog</a></li>
                                <li><a href="<?php echo site_url('publishing/newsletter'); ?>">Newsletter</a></li>
                            </ul>
                        </li>
