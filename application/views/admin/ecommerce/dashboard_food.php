...
<head>
    ...
    <title>Soup || All Foods in Admin Dashboard</title>
</head>
                ...
                <div class="row page-titles">
                    ...
                    <div class="col-md-7 align-self-center text-right">
                        <div class="d-flex justify-content-end align-items-center">
                            ...
                            <a href="<?php echo site_url('admin/upload'); ?>" class="btn btn-info d-none d-lg-block m-l-15"><i class="fa fa-plus-circle"></i> Add New Food</a>
                        </div>
                    </div>
                </div>
                <!-- ============================================================== -->
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="product-img">
                                    ...
                                    <div class="pro-img-overlay"><a href="<?php echo site_url('admin/edit_food/'.strtolower($all_fod->title)); ?>" class="bg-info"><i class="ti-marker-alt"></i></a> <a onclick="delete_food(<?php echo $all_fod->id; ?>)" class="bg-danger"><i class="ti-trash"></i></a></div>
                                </div>
