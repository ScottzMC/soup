...
<!-- Title -->
<title>Soup || Create an Account</title>
                    ...
                    <div class="col-xl-8 pull-xl-4 col-lg-7 pull-lg-5">
                      <form action="<?php echo base_url('register'); ?>" method="post">
                        <div class="bg-white p-4 p-md-5 mb-4">
                            <h4 class="border-bottom pb-4"><i class="ti ti-user mr-3 text-primary"></i>Register</h4>
                            <div class="row mb-5">
                        ...
                        <div class="text-center">
                            <button type="submit" name="registerBtn" class="btn btn-primary btn-lg"><span>Register!</span></button>
                        </div>
                      </form>
                      <?php
